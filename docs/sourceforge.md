...
- `dist/sourceforge/v1.0.0/Tomito-vlv-1.0.0-macos-unsigned.zip`
- `dist/sourceforge/v1.0.0/Tomito-vlv-1.0.0-macos-unsigned.zip.sha256`
- `dist/sourceforge/v1.0.0/readme.md`

## Upload manually

1. Open [Tomito vlv files](https://sourceforge.net/projects/tomito-vlv/files/).
2. Create the `v1.0.0` folder if it does not exist.
